...
import { EyeIcon, EyeOffIcon, UserCheck2Icon, MailboxIcon } from "lucide-react";
import {
	InputGroup,
	InputGroupAddon,
	InputGroupInput,
...
export function GetStarted({ ...props }: React.ComponentProps<typeof Card>) {
						...
						<Field>
							...
							<InputGroup>
								<InputGroupInput
									...
									aria-label="h"
									type="text"
									placeholder="hello@getalawyer.com"
								/>
								<InputGroupAddon>
									<MailboxIcon />
								</InputGroupAddon>
