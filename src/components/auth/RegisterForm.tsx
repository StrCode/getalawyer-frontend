import { LockComputerIcon, LockKeyIcon, MailOpenIcon, UserCircleIcon, UserEdit01Icon } from "@hugeicons/core-free-icons";
  ...
  const passwordForm = useAppForm({
    ...
    onSubmit: async ({ value }) => {
      try {
        ...
        navigate({ to: handleRegistrationComplete(userType) });
      } catch (error: any) {
      ...
      {step === "email" ? (
        ...
        <>
          ...
          <div className="">
            ...
            <h2 className="text-2xl text-center font-bold mt-4">Password Setup</h2>
